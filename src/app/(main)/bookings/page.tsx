...
export const metadata: Metadata = {
  title: 'Booking Saya — Jebrent',
  description: 'Daftar semua booking kendaraan Anda',
};
...
export default async function BookingsPage({
  ...
  // Filter di client (data sudah ada, tidak perlu query tambahan)
  const filtered =
    activeFilter === 'all'
      ? allBookings
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 flex items-center justify-between gap-4">
        ...
        <Link
          href="/vehicles"
          className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-primary-fg shadow-lg shadow-primary/25 transition-all hover:bg-primary-hover hover:shadow-xl hover:-translate-y-0.5"
        >
